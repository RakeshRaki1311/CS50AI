...
class CrosswordCreator():
    ...
    def enforce_node_consistency(self):
        ...
        """
        for each_variable in self.domains:
            for each_word in set(self.domains[each_variable]):
                if len(each_word) != each_variable.length:
                    self.domains[each_variable].remove(each_word)
